...
IMAGE_SIZE = 224 # MobileNetV2 also works well with 224x224 images
...
# The final layer in MobileNetV2's classifier has 1280 input features
...
# IMPORTANT: Use model.classifier.parameters() for MobileNetV2
