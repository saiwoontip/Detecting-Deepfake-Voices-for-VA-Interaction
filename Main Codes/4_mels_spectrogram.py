...
# The new main folder where spectrogram images will be saved
OUTPUT_IMAGE_DIR = 'spectrogram_images/'
SAMPLE_RATE = 16000

# --- 2. MAIN EXECUTION ---
if __name__ == '__main__':
    print("--- Starting Automatic Mel Spectrogram Generation ---")
    ...
    for audio_path in tqdm(files_to_process, desc="Generating Spectrograms"):
        try:
            ...
            # Get the relative path from the main audio directory (e.g., 'bonafide' or 'deepfake_gtts')
    ...
    print("\n--- All spectrograms have been saved successfully! ---")
